...
# === Bool arithmetic (bool promotes to int) ===
assert 1 + True == 2, 'int + True'
assert 1 + False == 1, 'int + False'
assert True + 1 == 2, 'True + int'
assert True + True == 2, 'True + True'
assert 5 - True == 4, 'int - True'
assert True - 1 == 0, 'True - int'
assert 5 * True == 5, 'int * True'
assert 5 * False == 0, 'int * False'
assert 5 // True == 5, 'int // True'
assert 5 % True == 0, 'int % True'
assert True**10 == 1, 'True ** int'
assert False**0 == 1, 'False ** 0'
assert 1.5 + True == 2.5, 'float + True'
assert True + 1.5 == 2.5, 'True + float'
assert 2.0 * False == 0.0, 'float * False'
